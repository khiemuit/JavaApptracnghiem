package com.example.khiemdeptrai.apptracnghiem.slide;
...
import com.example.khiemdeptrai.apptracnghiem.question.Question;
...
public class ScreenSlidePageFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        imgIcon.setImageResource(getResources().getIdentifier(getItem(mPageNumber).getImage()+"","drawable","com.example.khiemdeptrai.apptracnghiem"));
    ...
    // Lấy giá trị (vị trí) radiogroup chuyển thành A/B/C/D
    ...
    //Hàm kiểm tra câu đùng, nếu đúng thì đổi màu background radiobutton
